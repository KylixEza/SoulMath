package com.ramiyon.soulmath.presentation.custom.rounded_progress_bar
...
class SoulMathRoundedProgressBar @JvmOverloads constructor(
    context: Context,
    ...
    private val defaultArcAngle = 360.0
    ...
    private fun initByAttributes(attributes: TypedArray) {
        ...
        arcAngle = attributes.getFloat(R.styleable.ArcProgressBar_arc_angle,
            defaultArcAngle.toFloat()
        )
